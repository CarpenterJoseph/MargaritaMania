var recipeDB = (function () {
  // This is the variable (recipeDB) that we can use in other files to communicate with the DB
  ...
  rDB.createRecipeWithId = function (
    id,
    name,
    description,
    ingredients,
  ...
  rDB.clearDatabase = function () {
    var request = datastore
